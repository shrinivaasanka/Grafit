...
verhulstpearlreedlaw <- function(filename, lambdaVPR, lambdaMay, initialcondition, scalemult)
{
  ...
  print(coronavirus2019scaled)
  covid2019ts <- ts(rev(coronavirus2019scaled))
  ts.plot(covid2019ts)
  vprlogistic <- c()
  maylogistic <- c()
...
#corcoeff <- verhulstpearlreedlaw("./VerhulstPearlReedLogistic.dat.2",0.35201,0.35,0.00000000000001,3.0)
corcoeff <- verhulstpearlreedlaw("./VerhulstPearlReedLogistic.dat",1.05,0.06,0.00000000001,1.0)
